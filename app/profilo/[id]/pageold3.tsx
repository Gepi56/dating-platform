...
export default async function ProfiloPage({ params }: Props) {
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 py-8">
      {/* Placeholder colorato con iniziale */}
      <div className="aspect-[4/3] bg-gradient-to-br from-blue-400 to-purple-500 rounded-xl flex items-center justify-center mb-8">
